    ...
    <div class="flex-1 overflow-y-auto bg-gray-50 h-full">
      ...
      <main class="p-8">
        <div class="fade-in max-w-3xl mx-auto">
            ...
            <form method="POST" action="{{ route('admin.service_requests.store') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                @csrf
                
                <div class="p-8 space-y-6">
                    <div>
                        <label for="event_id" class="block text-sm font-medium text-gray-700 mb-1">Pilih Acara Berkaitan</label>
                        <select name="event_id" id="event_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('event_id') border-red-500 @enderror">
                ...
                <div class="px-8 py-4 bg-gray-50 border-t border-gray-100 flex justify-end space-x-3">
                    <a href="{{ route('admin.service_requests.index') }}" class="px-6 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors shadow-sm">
                        Batal
                    </a>
