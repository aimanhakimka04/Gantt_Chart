  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-white shadow-xl z-20 hidden md:block flex-shrink-0">
      ...
      <nav class="mt-6 px-4 space-y-2 overflow-y-auto h-[calc(100vh-180px)]">
        ...
        <a href="{{ route('admin.service_requests.index') }}" class="sidebar-item active w-full flex items-center px-4 py-3 text-left rounded-lg text-sm font-medium">
        ...
        <div class="fade-in">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500">{{ $serviceRequests->count() }} permintaan direkodkan</p>
                </div>
                
                <a href="{{ route('admin.service_requests.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                @if($serviceRequests->isEmpty())
                    <div class="p-12 text-center">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('admin.service_requests.create') }}" class="text-blue-600 hover:text-blue-800 font-medium hover:underline">
                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                ...
                                <tr class="hover:bg-blue-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900">
                                        ...
                                        <div class="text-xs text-gray-400 font-normal">{{ $request->committee->email }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        @if($request->event)
