        ...
        <div class="fade-in">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500">{{ $events->count() }} acara dijumpai</p>
                </div>
                
                @if(Auth::guard('committee')->check())
                <a href="{{ route('admin.events.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-gray-600">
                                    <div class="flex items-center">
                                        ...
                                        {{ $event->venue ?? 'Tidak dinyatakan' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-gray-500 max-w-xs truncate" title="{{ $event->description }}">
                                    {{ Str::limit($event->description, 50) }}
                                </td>
                                <td class="px-6 py-4 text-center">
                                    @if(Auth::guard('committee')->check())
                                    <div class="flex justify-center space-x-2">
                                        <a href="{{ route('admin.events.edit', $event) }}" class="text-blue-600 hover:text-blue-800 bg-blue-100 hover:bg-blue-200 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">
                                            <i class="fas fa-edit mr-1"></i> Edit
                                        </a>
                                        <button onclick="openDeleteModal({{ $event->id }}, '{{ addslashes($event->title) }}')" class="text-red-600 hover:text-red-800 bg-red-100 hover:bg-red-200 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center text-gray-400">
                                        ...
                                        @if(Auth::guard('committee')->check())
                                        <a href="{{ route('admin.events.create') }}" class="text-blue-600 hover:underline text-sm font-medium">Cipta Acara Pertama</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
