      ...
      <main class="p-8">
        <div class="fade-in max-w-3xl mx-auto">
            ...
            <div class="flex items-center mb-6">
                <a href="<?php echo e(route('admin.donation_programs.index')); ?>" class="mr-4 p-2 bg-white border border-gray-200 rounded-lg text-gray-600 hover:text-blue-600 hover:border-blue-300 transition-colors shadow-sm">
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 card-hover">
                <form action="<?php echo e(route('admin.donation_programs.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center justify-end space-x-3 mt-8 pt-6 border-t border-gray-100">
                        <a href="<?php echo e(route('admin.donation_programs.index')); ?>" class="px-6 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors shadow-sm">
                            Batal
                        </a>
...
</html><?php /**PATH /var/www/masjid_app/resources/views/admin/donation_programs/create.blade.php ENDPATH**/ ?>