  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-white shadow-xl z-20 hidden md:block flex-shrink-0">
      ...
      <nav class="mt-6 px-4 space-y-2 overflow-y-auto h-[calc(100vh-180px)]">
        ...
        <a href="<?php echo e(route('admin.donation_programs.index')); ?>" class="sidebar-item active w-full flex items-center px-4 py-3 text-left rounded-lg text-sm font-medium">
    ...
    <div class="flex-1 overflow-y-auto bg-gray-50 h-full p-8">
        ...
        <div class="fade-in">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('admin.donation_programs.create')); ?>" class="inline-flex items-center bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors shadow-sm text-sm font-medium">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150">
                                <td class="px-6 py-4 font-medium text-gray-900">
                                    ...
                                    <div class="text-xs text-gray-500 font-normal mt-1"><?php echo e(Str::limit($program->description, 40)); ?></div>
                                </td>
                                <td class="px-6 py-4 font-mono text-gray-600">
                                    RM <?php echo e(number_format($program->target_amount, 2)); ?>

                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="font-bold text-gray-800">RM <?php echo e(number_format($program->current_amount, 2)); ?></span>
                                        <span class="text-xs text-gray-500 font-semibold"><?php echo e($program->percentage); ?>%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-1.5 overflow-hidden">
                                        <div class="bg-blue-600 h-1.5 rounded-full transition-all duration-500" style="width: <?php echo e($program->percentage); ?>%"></div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <form action="<?php echo e(route('admin.donation_programs.destroy', $program)); ?>" method="POST" onsubmit="return confirm('Adakah anda pasti mahu memadam program ini? Data sumbangan berkaitan mungkin terjejas.');" class="inline-block">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH /var/www/masjid_app/resources/views/admin/donation_programs/index.blade.php ENDPATH**/ ?>