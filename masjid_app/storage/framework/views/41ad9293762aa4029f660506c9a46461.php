...
<body class="bg-gray-50 text-gray-800">
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-white shadow-xl z-20 hidden md:block flex-shrink-0">
      ...
      <nav class="mt-6 px-4 space-y-2 overflow-y-auto h-[calc(100vh-180px)]">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-item active w-full flex items-center px-4 py-3 text-left rounded-lg text-sm font-medium text-gray-600 hover:text-blue-600">
        ...
        <div class="fade-in">
              ...
              <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 card-hover">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">RM <?php echo e(number_format($totalDonations, 2)); ?></p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 card-hover">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($events->count()); ?></p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 card-hover">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e(\App\Models\Participant::count()); ?></p>
                  </div>
                </div>
              </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route('admin.events.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-medium">Lihat Semua</a>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $events->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($event->title); ?></td>
                                <td class="px-6 py-4 text-gray-500"><?php echo e(\Carbon\Carbon::parse($event->event_date)->format('d M Y')); ?></td>
                                <td class="px-6 py-4"><?php echo e($event->capacity ?? 'Unlimited'); ?></td>
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                    Tiada acara akan datang. <a href="<?php echo e(route('admin.events.create')); ?>" class="text-blue-600 hover:underline">Cipta acara baru.</a>
                                </td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
 ...
 <script>
    ...
    async function fetchVisitData() {
        try {
            const response = await fetch(`<?php echo e(route('admin.api.visit_stats')); ?>?range=${currentRange}`);
    ...
    function initDonationChart() {
        ...
        const chartDataFromBackend = <?php echo json_encode($chartData, 15, 512) ?>; 
...
</html><?php /**PATH /var/www/masjid_app/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>