  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-white shadow-xl z-20 hidden md:block flex-shrink-0">
      ...
      <nav class="mt-6 px-4 space-y-2 overflow-y-auto h-[calc(100vh-180px)]">
        ...
        <a href="<?php echo e(route('admin.registrations.index')); ?>" class="sidebar-item active w-full flex items-center px-4 py-3 text-left rounded-lg text-sm font-medium">
        ...
        <div class="fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-800"><?php echo e($registrations->where('status', 'pending')->count()); ?></p>
                    </div>
                </div>
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-800"><?php echo e($registrations->where('status', 'approved')->count()); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                    ...
                    <div class="text-xs text-gray-500">Jumlah: <?php echo e($registrations->count()); ?></div>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap text-gray-600">
                                    ...
                                    <div class="text-xs text-gray-400"><?php echo e($reg->created_at->format('h:i A')); ?></div>
                                </td>
                                <td class="px-6 py-4 font-medium text-gray-900">
                                    <?php echo e($reg->participant->name); ?>

                                    <div class="text-xs text-gray-500 font-normal"><?php echo e($reg->participant->email); ?></div>
                                </td>
                                <td class="px-6 py-4 text-gray-700">
                                    <?php echo e($reg->event->title); ?>

                                    <div class="text-xs text-gray-500">
                                        <i class="far fa-calendar-alt mr-1"></i> <?php echo e(\Carbon\Carbon::parse($reg->event->event_date)->format('d M Y')); ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    ...
                                    <div class="flex justify-center space-x-2">
                                        <form method="POST" action="<?php echo e(route('admin.registrations.approve', $reg)); ?>" onsubmit="return confirm('Adakah anda pasti mahu meluluskan pendaftaran ini?');">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.registrations.reject', $reg)); ?>" onsubmit="return confirm('Adakah anda pasti mahu menolak pendaftaran ini?');">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
...
</html><?php /**PATH /var/www/masjid_app/resources/views/admin/registrations/index.blade.php ENDPATH**/ ?>