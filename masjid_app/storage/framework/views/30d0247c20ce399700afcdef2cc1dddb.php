...
<head>
  ...
  <title>Permintaan Servis - Admin Panel</title>
    ...
    <div class="flex-1 overflow-y-auto bg-gray-50 h-full">
      ...
      <header class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
        <div class="flex items-center justify-between px-8 py-4">
          <div>
            <h2 class="text-2xl font-bold text-gray-800">Permintaan Servis AJK</h2>
            <p class="text-sm text-gray-500">Uruskan permintaan logistik dan bantuan untuk acara</p>
          </div>
      ...
      <main class="p-8">
        <div class="fade-in">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h3 class="text-lg font-semibold text-gray-800">Senarai Permintaan</h3>
                    <p class="text-sm text-gray-500"><?php echo e($serviceRequests->count()); ?> permintaan direkodkan</p>
                </div>
                
                <a href="<?php echo e(route('admin.service_requests.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <?php if($serviceRequests->isEmpty()): ?>
                    <div class="p-12 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-900">Tiada Permintaan</h3>
                        <p class="mt-1 text-gray-500">Belum ada sebarang permintaan servis direkodkan.</p>
                        <div class="mt-6">
                            <a href="<?php echo e(route('admin.service_requests.create')); ?>" class="text-blue-600 hover:text-blue-800 font-medium hover:underline">
                                Cipta Permintaan Pertama &rarr;
                            </a>
                        </div>
                    </div>
                <?php else: ?>
                        ...
                        <table class="w-full text-sm text-left">
                            <thead class="bg-gray-50 text-gray-500 uppercase text-xs">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 font-semibold tracking-wider">Pemohon (AJK)</th>
                                    <th class="px-6 py-4 font-semibold tracking-wider">Acara Berkaitan</th>
                                    <th class="px-6 py-4 font-semibold tracking-wider">Butiran Permintaan</th>
                                    <th class="px-6 py-4 font-semibold tracking-wider">Tarikh Dibuat</th>
                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                ...
                                <tr class="hover:bg-blue-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900">
                                        <?php echo e($request->committee->name); ?>

                                        <div class="text-xs text-gray-400 font-normal"><?php echo e($request->committee->email); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <?php if($request->event): ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                                <?php echo e($request->event->title); ?>

                                            </span>
                                        <?php else: ?>
                                            <span class="text-gray-400 italic">Tiada / Umum</span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-gray-500 text-xs">
                                        <?php echo e($request->created_at->format('d M Y')); ?><br>
                                        <?php echo e($request->created_at->format('h:i A')); ?>
...
</html><?php /**PATH /var/www/masjid_app/resources/views/admin/service_requests/index.blade.php ENDPATH**/ ?>