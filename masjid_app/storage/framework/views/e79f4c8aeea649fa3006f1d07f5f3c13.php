        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 sticky top-24">
                    ...
                    <nav class="p-2 space-y-1">
                        ...
                        <a href="<?php echo e(route('participant.registrations')); ?>" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg bg-blue-50 text-blue-700">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6 mb-6 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <a href="<?php echo e(route('home')); ?>#kegiatan" class="mt-4 md:mt-0 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-medium transition-colors shadow-sm flex items-center">
                        ...
                        <?php $__currentLoopData = $registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
                                <div class="h-2 w-full 
                                    <?php if($registration->status === 'approved'): ?> bg-green-500
                                    <?php elseif($registration->status === 'rejected'): ?> bg-red-500
                                ...
                                <div class="p-6">
                                    ...
                                    <h3 class="text-lg font-bold text-gray-800 mb-2 line-clamp-1">
                                        <?php echo e($registration->event->title ?? 'Nama Program Tidak Dijumpai'); ?>
                                    ...
                                    <div class="space-y-3 text-sm text-gray-600 mb-4">
                                        <div class="flex items-center">
                                            ...
                                            <span><?php echo e(\Carbon\Carbon::parse($registration->event->event_date)->format('d F Y')); ?></span>
                                        </div>
                                        <div class="flex items-center">
                                            <i class="fas fa-map-marker-alt w-5 text-gray-400"></i>
                                            <span><?php echo e($registration->event->venue ?? 'Lokasi: Dewan Utama Masjid'); ?></span>
                                        </div>
                                        <div class="flex items-center">
                                            <i class="fas fa-clock w-5 text-gray-400"></i>
                                            <span>Didaftar pada: <?php echo e(\Carbon\Carbon::parse($registration->created_at)->format('d M Y, h:i A')); ?></span>
                                        </div>
                                    </div>
                ...
                <?php else: ?>
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
                        ...
                        <a href="<?php echo e(route('home')); ?>#kegiatan" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors shadow-sm">
...
</html><?php /**PATH /var/www/masjid_app/resources/views/Participant/registrations/my-registrations.blade.php ENDPATH**/ ?>